          ...
          <form onSubmit={handleVerify} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                maxLength={8}
                placeholder="000000"
                className="w-full h-12 sm:h-14 bg-white/[0.03] border border-white/[0.08] rounded-xl sm:rounded-2xl px-4 sm:px-5 text-white text-center text-2xl tracking-[0.5em] font-bold focus:border-gold/40 focus:bg-white/[0.05] transition-all duration-300"
                value={otp}
            ...
            <div className="mt-6 text-center">
              {timeLeft > 0 ? (
                ...
                <button
                  ...
                  className="text-gold text-sm font-medium hover:text-white transition-colors disabled:opacity-50"
                >
...
export default function VerifyResetOtpPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center"><Loader2 className="w-8 h-8 text-gold animate-spin" /></div>}>
      <VerifyResetOtpInner />
    </Suspense>
  );
}
