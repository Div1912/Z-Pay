          ...
          <div className="p-4 bg-white/5 rounded-2xl space-y-3">
            <div className="flex items-center gap-3">
              <div
                ...
                style={{ backgroundImage: (receiver as any)?.avatar_url ? `url(${(receiver as any).avatar_url})` : undefined }}
              >
                {!(receiver as any)?.avatar_url && (receiver.display_name?.[0] || receiver.username[0])}
              </div>
              <div>
