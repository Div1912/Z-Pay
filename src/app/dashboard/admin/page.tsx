      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight" style={{ fontFamily: 'var(--font-syne)' }}>
            Arbiter <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-[#FBBF24]">Console</span>
          </h1>
              ...
              <div className="flex flex-col md:flex-row justify-between gap-6 relative z-10">
                <div className="flex-1 space-y-4">
                  <div>
                    ...
                    <p className="text-2xl font-black text-gold mt-1">{contract.amount} {contract.currency}</p>
                  </div>
