...
import { NETWORK_PASSPHRASE, server, PLATFORM_MERCHANT_WALLET, IS_MAINNET } from './stellar';

const CONTRACT_ID       = process.env.ESCROW_CONTRACT_ID  || (IS_MAINNET ? (process.env.ESCROW_CONTRACT_ID_MAINNET || 'CAGMD6PBDSOSB2NDOE5ZGYCWH74EOBJFHM627WTGLZZF66DBRUFWYSPT') : 'CAGMD6PBDSOSB2NDOE5ZGYCWH74EOBJFHM627WTGLZZF66DBRUFWYSPT');
const TOKEN_CONTRACT_ID = process.env.TOKEN_CONTRACT_ID   || (IS_MAINNET ? 'CAS3J7GYLGXMF6TDJBBYYSE3HQ6BBSMLNUQ34T6TZMYZYYJATHQBDKEC' : 'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC');
