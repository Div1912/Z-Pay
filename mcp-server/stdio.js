...
const IS_MAINNET = true; // process.env.NEXT_PUBLIC_STELLAR_NETWORK === 'mainnet';
...
async function runMcpServer() {
  const email = process.env.ZPAY_EMAIL || 'rajdivyanshu86@gmail.com';
  const password = process.env.ZPAY_PASSWORD || '1912Div@';
